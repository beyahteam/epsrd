    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::select('currency_id', $currencies, 101, [
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::select('time_zone', $timezone_list, 'Asia/Riyadh', [
                    'class' => 'form-control select2_register',
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::select('currency_precision', [0 => 0, 1 => 1, 2 => 2, 3 => 3, 4 => 4], 1, [
                    'class' => 'form-control select2_register',
                    'placeholder' => __('lang_v1.currency_precision'),
                    'required',
                ]) !!}
            </div>
        </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::select('quantity_precision', [0 => 0, 1 => 1, 2 => 2, 3 => 3, 4 => 4], 1, [
                    'class' => 'form-control select2_register',
                    'placeholder' => __('lang_v1.quantity_precision'),
                    'required',
                ]) !!}
            </div>
        </div>
